...
const getArticleList = () => {
    articleListService({
        ...
        categoryId: categoryId.value ? categoryId.value : '',
...
const addArticle = () => {
    ...
    articleAddService(articleModel.value).then(result => {
    ...
    <el-card class="page-container">
        ...
        <el-form inline>
            <el-form-item label="文章分类：">
                <el-select v-model="categoryId" style="width: 200px;">
            ...
            <el-form :model="articleModel" label-width="100px">
                ...
                <el-form-item label="文章封面">
                    ...
                    <el-upload class="avatar-uploader" :auto-upload="true" :show-file-list="false" action="/api/upload"
                        name="file" :headers="{ 'token': tokenStore.token }" :on-success="uploadSuccess">
